...
public class SeekAssignConsumer {
    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(SeekAssignConsumer.class.getName());
...
//        kafkaConsumer.subscribe(Arrays.asList(topic));
        TopicPartition read_partition = new TopicPartition(topic,0);
        kafkaConsumer.assign(Arrays.asList(read_partition));
        kafkaConsumer.seek(read_partition,15L);
        from_offset=0;
